...
import { Plus, Search, X, Loader2, AlertCircle, Award, FileText, Eye, RotateCcw, CheckCircle2, Upload } from 'lucide-react';
              ...
              <div className="w-full max-w-lg" onClick={e => e.stopPropagation()}>
                <CertificateCanvas
                  data={{
                    ...
                    background_url: preview.background_url,
                    institute_logo_url: preview.institute_logo_url,
